...
export const V1 = () => {
  ...
  return (
    <motion.div
      ...
      className={`bg-background relative overflow-hidden rounded-3xl w-full shadow-zinc-100 transition-shadow ${open ? 'shadow-xl' : 'shadow-sm'}`}
          ...
          >
            <motion.div layout="position">
              <div className="flex items-center gap-4 md:gap-8">
                ...
                >
                  <span>{open ? 'Hide' : 'More'} details</span>
                  {open ? (
