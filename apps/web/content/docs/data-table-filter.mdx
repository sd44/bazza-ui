...
- TanStack Table, static *(i.e. no data fetching, mainly for demo purposes)*
  ...
  - [Source code](https://github.com/kianbazza/ui/tree/main/apps/web/app/demos/client/tst-static)

#### Server-side filtering

- TanStack Table, TanStack Query, `nuqs`
  - [Live demo](/demos/server/tst-query)
  - [Source code](https://github.com/kianbazza/ui/tree/main/apps/web/app/demos/server/tst-query)
